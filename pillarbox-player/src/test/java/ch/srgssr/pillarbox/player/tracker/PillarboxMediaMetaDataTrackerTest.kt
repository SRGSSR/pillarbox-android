...
class PillarboxMediaMetaDataTrackerTest {
    ...
    private companion object {
        ...
        private val CHAPTER_1 = Chapter(id = "Chapter1", 0, 5_000L, mediaMetadata = androidx.media3.common.MediaMetadata.Builder().build())
        private val CHAPTER_2 =
            Chapter(id = "Chapter2", 5_000L, NEAR_END_POSITION_MS, mediaMetadata = androidx.media3.common.MediaMetadata.Builder().build())
        private val CHAPTER_3 = Chapter(id = "Chapter3", 2_000L, 5_000L, mediaMetadata = androidx.media3.common.MediaMetadata.Builder().build())
        private val CHAPTER_4 =
            Chapter(id = "Chapter4", 10_000L, NEAR_END_POSITION_MS, mediaMetadata = androidx.media3.common.MediaMetadata.Builder().build())

    ...
    private fun createOkHttpClient(requestedUrls: MutableList<HttpUrl>): OkHttpClient {
        return OkHttpClient.Builder()
            .addInterceptor { chain ->
                ...
                val mediaComposition = DummyMediaCompositionProvider.createMediaComposition(
                    urn = DummyMediaCompositionProvider.URN_HLS_RESOURCE,
                    listResource = listOf(DummyMediaCompositionProvider.createResource(Resource.Type.HLS)),
                )

...
sealed class BlockReasonException(message: String) : IOException(message) {
    ...
    /**
     * Represents an exception thrown when a [Chapter] is blocked due to the usage of a VPN. This corresponds to [BlockReason.VPN].
     */
    class VPN : BlockReasonException(BlockReason.VPN) {
        override val messageResId: Int
            get() = R.string.blockReason_vpn
    }
